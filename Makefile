all:
	...
	nasm -g   src/kernel/multiboot.s      -o obj/kernel/multiboot.s.o      -f elf
	...
	nasm -g   src/kernel/common.s         -o obj/kernel/common.s.o         -f elf
	gcc -g -c src/kernel/desctables/gdt.c -o obj/kernel/desctables/gdt.c.o -std=c99 -O3
	nasm -g   src/kernel/desctables/gdt.s -o obj/kernel/desctables/gdt.s.o -f elf
	gcc -g -c src/kernel/desctables/idt.c -o obj/kernel/desctables/idt.c.o -std=c99 -O3
	nasm -g   src/kernel/desctables/idt.s -o obj/kernel/desctables/idt.s.o -f elf
